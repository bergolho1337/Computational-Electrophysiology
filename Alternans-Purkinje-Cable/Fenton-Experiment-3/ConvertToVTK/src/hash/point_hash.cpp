...
struct point_hash* internal_point_hash_create(int size) {
    ...
    d = (struct point_hash*)malloc(sizeof(*d));
...
void point_hash_insert(struct point_hash* d, struct point_3d key, long long int value)
{
    struct elt *e;
    unsigned long h;
...
long long int point_hash_search(struct point_hash* d, struct point_3d key) {
    struct elt *e;
