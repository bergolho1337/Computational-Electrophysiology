...
void DiFrancesco::initConst (double CONSTANTS[], double RATES[], double STATES[])
{
    STATES[0] = -87;
    STATES[1] = 4;
    STATES[2] = 140;
...
void DiFrancesco::compVariables (double t, double CONSTANTS[], double RATES[], double STATES[], double ALGEBRAIC[])
{
