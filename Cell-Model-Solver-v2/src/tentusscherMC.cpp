...
void TenTusscherMC::initConst (double CONSTANTS[], double RATES[], double STATES[])
{
    STATES[0] = -85.423;        // V        FE
    STATES[1] = 138.52;         // Ki       FE 
    STATES[2] = 10.132;         // Nai      FE
    STATES[3] = 0.000153;       // Cai      FE
    STATES[4] = 0.0165;         // Xr1      RL
    STATES[5] = 0.473;          // Xr2      RL
    STATES[6] = 0.0174;         // Xs       RL
    STATES[7] = 0.00165;        // m        RL
    STATES[8] = 0.749;          // h        RL
    STATES[9] = 0.6788;         // j        RL
    STATES[10] = 0.00042;       // Cass     FE
    STATES[11] = 3.288e-5;      // d        RL
    STATES[12] = 0.7026;        // f        RL
    STATES[13] = 0.9526;        // f2       RL
    STATES[14] = 0.9942;        // fCass    RL
    STATES[15] = 0.999998;      // s        RL
    STATES[16] = 2.347e-8;      // r        RL
    STATES[17] = 4.272;         // CaSR     FE
    STATES[18] = 0.8978;        // Rprime   FE
...
void TenTusscherMC::compRates (double t, double CONSTANTS[], double RATES[], double STATES[], double ALGEBRAIC[])
{
...
void TenTusscherMC::compVariables(double t, double* CONSTANTS, double* RATES, double* STATES, double* ALGEBRAIC)
{
...
void TenTusscherMC::compRates_FE (double t, double CONSTANTS[], double RATES[], double STATES[], double ALGEBRAIC[])
{
    RATES[0] = - (ALGEBRAIC[47]+ALGEBRAIC[54]+ALGEBRAIC[48]+ALGEBRAIC[49]+ALGEBRAIC[52]+ALGEBRAIC[55]+ALGEBRAIC[50]+ALGEBRAIC[51]+ALGEBRAIC[56]+ALGEBRAIC[53]+ALGEBRAIC[58]+ALGEBRAIC[57]+ALGEBRAIC[12]);
    RATES[1] =  (( - 1.00000*((ALGEBRAIC[47]+ALGEBRAIC[54]+ALGEBRAIC[48]+ALGEBRAIC[49]+ALGEBRAIC[58]+ALGEBRAIC[12]) -  2.00000*ALGEBRAIC[55]))/( 1.00000*CONSTANTS[4]*CONSTANTS[2]))*CONSTANTS[3];
    RATES[2] =  (( - 1.00000*(ALGEBRAIC[50]+ALGEBRAIC[51]+ 3.00000*ALGEBRAIC[55]+ 3.00000*ALGEBRAIC[56]))/( 1.00000*CONSTANTS[4]*CONSTANTS[2]))*CONSTANTS[3];
...
void TenTusscherMC::RL (double DT, double CONSTANTS[], double RATES[], double STATES[], double ALGEBRAIC[])
{
