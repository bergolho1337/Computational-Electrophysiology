...
void TenTusscherEPI::initConst (double CONSTANTS[], double RATES[], double STATES[])
{
    STATES[0] = -85.23;        // V        FE
    STATES[1] = 136.89;         // Ki       FE 
    STATES[2] = 8.604;         // Nai      FE
    STATES[3] = 0.000126;       // Cai      FE
    STATES[4] = 0.00621;         // Xr1      RL
    STATES[5] = 0.4712;          // Xr2      RL
    STATES[6] = 0.0095;         // Xs       RL
    STATES[7] = 0.00172;        // m        RL
    STATES[8] = 0.7444;          // h        RL
    STATES[9] = 0.7045;         // j        RL
    STATES[10] = 0.00036;       // Cass     FE
    STATES[11] = 3.373e-5;      // d        RL
    STATES[12] = 0.7888;        // f        RL
    STATES[13] = 0.9755;        // f2       RL
    STATES[14] = 0.9953;        // fCass    RL
    STATES[15] = 0.999998;      // s        RL
    STATES[16] = 2.42e-8;      // r        RL
    STATES[17] = 3.64;         // CaSR     FE
    STATES[18] = 0.9073;        // Rprime   FE
...
void TenTusscherEPI::compRates (double t, double CONSTANTS[], double RATES[], double STATES[], double ALGEBRAIC[])
{
...
void TenTusscherEPI::compVariables(double t, double* CONSTANTS, double* RATES, double* STATES, double* ALGEBRAIC)
{
...
void TenTusscherEPI::compRates_FE (double t, double CONSTANTS[], double RATES[], double STATES[], double ALGEBRAIC[])
{
...
void TenTusscherEPI::RL (double DT, double CONSTANTS[], double RATES[], double STATES[], double ALGEBRAIC[])
{
